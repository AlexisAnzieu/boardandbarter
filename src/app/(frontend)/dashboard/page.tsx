...
export default async function DashboardPage() {
  ...
  const timeline = [
    {
      title: 'Sleeve check: Brass Birmingham',
      meta: 'Melanie • Club Meeple',
      time: '08:12',
      status: 'complete',
    },
    {
      title: 'Swap confirmed: Ark Nova FR/EN',
      meta: 'Axel <-> Jo',
      time: '09:05',
      status: 'complete',
    },
    {
      title: 'Courier booked: Frosthaven insert',
      meta: 'La Taniere',
      time: '10:44',
      status: 'complete',
    },
    ...
    <main className="dashboard">
      <header className="dashboard__header">
        <div>
          ...
          <p className="lead">
            Quest log updated. Here&apos;s your guild activity, trades in progress, and incoming
            loot.
          </p>
        </div>
